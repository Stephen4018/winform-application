...
/// </summary>
{
    ...
    public class Form1Tests
    {
        ...
        public void SetUp()
        {
            // Initialize your mocks and objects
            commandParserMock = new Mock<ICommandParser>();
            form = new Form1(commandParserMock.Object);
        }

        [Test]
        public void ExecuteCommand_ShouldCall_CommandParser_Methods()
        {
            // Arrange
            form.Text = "circle 30";
            ...
            // Assert
            commandParserMock.Verify(parser => parser.DrawCire(It.IsAny<Graphics>(), It.IsAny<Point>(), It.IsAny<int>()), Times.Once);
            // Add more verifications for other methods called in ExecuteCommand
        }

        [Test]
        public void LoadCommandFromFile_ShouldCall_CommandParser_LoadCommandFromFile()
        {
            // Arrange
            string fileName = "test.txt";

            // Act
            //commandParserMock.LoadCommandFromFile(fileName);

            // Assert
            commandParserMock.Verify(parser => parser.LoadCommandFromFile(fileName), Times.Once);
        }

        [Test]
        public void SaveCommandToFile_ShouldCall_CommandParser_SaveCommandToFile()
        {
            // Arrange
            string fileName = "test.txt";

            // Act
            //form.SaveCommandToFile(fileName);

            // Assert
            commandParserMock.Verify(parser => parser.SaveCommandToFile(fileName), Times.Once);
        }

        // Add more tests for other methods in Form1 and ICommandParser as needed
    }
    //public class Form1Tests
    //{
    //    /// <summary>
